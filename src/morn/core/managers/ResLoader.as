...
package morn.core.managers {
	...
	public class ResLoader {
		...
		private static var parserMap:Dictionary = new Dictionary;
		public static function registParser(type:int , parser:Function):void{
			parserMap[type] = parser;
		}
		
		private static function getParser(type:int):Function
		{
		...
		private function doLoad():void {
			...
			else/* (_type == BMD || _type == AMF || _type == DB || _type == BYTE || _type == SWF) */{
		...
		private function onComplete(e:Event):void {
			var content:* = null;
			var func:Function = getParser(_type);
			if(func){
				content = func(_url,_urlLoader.data);
			}
			else if (_type == SWF || _type == BMD) {
